...
public class SensitiveDataAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("@annotation(com.logiant.common.desensitization.annotation.SensitiveEncode) || @annotation(com.logiant.common.desensitization.annotation.SensitiveDecode)")
